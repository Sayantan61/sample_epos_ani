...
public class TblMapping  implements java.io.Serializable {
    ...
    public TblMapping(BigDecimal ITripId, TblCard tblCard, TblDo tblDo, TblDriver tblDriver, TblPlant tblPlant, TblProcess tblProcess, TblTransporter tblTransporter, TblVehicle tblVehicle, Date dtCreated, boolean BIsActive, Set tblExceptionses, Set tblVehicleFlights) {
       this.ITripId = ITripId;
